...
template<> PROCEDURALLEVELUTILITYMAKER_API UScriptStruct* StaticStruct<FBuildingBlockData>()
{
	...
	struct Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_79603815(TEXT("/Script/ProceduralLevelUtilityMaker"),
		Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ADBLinkGameStudios_PluginsMaker_Plugins_ProceduralLevelUtilityMaker_Source_ProceduralLevelUtilityMaker_Public_PLUMBuildingBlocksData_h_Statics::ScriptStructInfo),
		nullptr, 0);
